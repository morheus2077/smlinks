       ...
       <Header/>
        ...
        <form action="">
            <div className="flex flex-col">
                    ...
                    <Input
                    className="bg-white w-[500px] h-[30px] rounded-xs indent-3 text-black mt-4"
            ...
            <div className="border  border-blue-600 flex flex-col items-center justify-start h-[100px] gap-5">
                <label htmlFor="">Veja como está ficando:</label>
                <article
                className="h-[35px] rounded-sm w-[420px] flex items-center justify-center"
            ...
            <button className="flex items-center justify-center gap-3 bg-blue-600 w-full mt-2 rounded-sm h-[35px] cursor-pointer">cadastrar <i><Link size={18}/></i></button>
        </form>
        </div>
        </>
    )
